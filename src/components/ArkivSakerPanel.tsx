...
function ArkivRadGroup({ children }: { sak: SakMedStemmer; children: (utfoldet: boolean, toggle: () => void) => React.ReactNode }) {
...
export default function ArkivSakerPanel() {
                    ...
                    {(utfoldet, toggle) => (
                      <>
                        <ArkivRad
                          ...
                          mandater={mandater}
                          flertall={flertall}
                          delsakToggle={harDelsaker ? { utfoldet, antall: sak.delsaker!.length, onToggle: toggle } : undefined}
